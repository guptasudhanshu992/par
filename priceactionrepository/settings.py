...
MEDIA_URL = f"{config('CLOUDFLARE_R2_BUCKET_ENDPOINT').rstrip('/')}/{config('CLOUDFLARE_R2_BUCKET')}/"
...
AWS_QUERYSTRING_AUTH = config("AWS_QUERYSTRING_AUTH", cast=str, default="False")
AWS_S3_FILE_OVERWRITE = config("AWS_S3_FILE_OVERWRITE", cast=str, default="False")
